...
# Data(Train)
train_sal <- read.csv("E:\\Assignment\\12)Naive Bayes\\SalaryData_Train.csv")
str(train_sal)
...
# Data(Test)
test_sal <- read.csv("E:\\Assignment\\12)Naive Bayes\\SalaryData_Test.csv")
str(test_sal)
...
confusionMatrix(Model_pred,test_sal$Salary, positive = "1")
